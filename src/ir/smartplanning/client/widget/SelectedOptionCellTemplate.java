...
public interface SelectedOptionCellTemplate  extends SafeHtmlTemplates {

	@SafeHtmlTemplates.Template("<div align='{0}' class='{7}'><label  dir='{2}'  name='equation' class='{5}'/>" +
			"<input checked  name='{1}'  type=\"radio\" class=\"{6}\"/><span class='{8}'>{3})</span> {4}</label></div>")
	...
	@SafeHtmlTemplates.Template("<span>" +
			"<input checked  type=\"radio\" name='{1}' class=\"{0}\"/></span>")
